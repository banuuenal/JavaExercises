...
public class Duration {
    ...
    public static String getDurationString(long minutes, long seconds) {
        ...
        hoursString = getTimeString(hours, hoursString);
        String minutesString = remainMin + "m";
        minutesString = getTimeString(remainMin, minutesString);
        String secondsString = seconds + "s";
        secondsString = getTimeString(seconds, secondsString);
        return hoursString+" "+minutesString+" "+secondsString;
    }

    private static String getTimeString(long time, String timeString) {
        if (time< 10) {
